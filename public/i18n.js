...
const translations = {
  en: {
    ...
    'model.finishingRegression': 'Finishing regression',
    ...
    'team.finishing': 'Finishing',
    'team.finishingHint': 'Season-level conversion quality: log(goals / xG). Positive = clinical, negative = wasteful.',
  ...
  no: {
    ...
    'model.finishingRegression': 'Avslutningsregresjon',
    ...
    'team.finishing': 'Avslutning',
    'team.finishingHint': 'Sesongnivå konverteringskvalitet: log(mål / xG). Positivt = klinisk, negativt = bortkastet.',
