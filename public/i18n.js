...
const translations = {
  en: {
    ...
    'table.col.projGoalsFor': 'GF',
    'table.col.projGoalsFor.desc': ', projected final goals for: goals so far plus the simulated rest of the season',
    'table.col.projGoalsAgainst': 'GA',
    'table.col.projGoalsAgainst.desc': ', projected final goals against',
    'table.col.projGoalDiff': 'GD',
    'table.col.projGoalDiff.desc': ', projected final goal difference',
    ...
    'table.noFixturesLeft': 'No matches left to play',
    ...
    'model.how1': 'Each club carries one ELO rating. After every match, the winner gains points and the loser loses them — more if the result was unexpected, and less if xG shows the win was lucky. The gap between two clubs\' ratings gives one set of win/draw/loss odds; a second set comes from each club\'s attack and defence ratings, which move on expected goals (xG) — FotMob for Eliteserien, Sofascore for OBOS-ligaen. The odds shown blend 25 % Elo with 75 % attack/defence. From 2022 both divisions use a faster K-factor and a lower xG weight (K=30, α=30 %); earlier seasons use K=20, α=45 %.',
    ...
    'model.homeAdvantageBeta': 'Home advantage β',
    'model.blendGamma': 'Blend sharpening γ',
    ...
    'model.strengthSd': 'Strength shock per run (log-odds, sd)',
    ...
    'team.played': 'Played',
    'team.attack': 'Attack',
    'team.xgRaw': '{value} xG per match · avg {avg}',
    'team.defence': 'Defence',
    'team.attackHint': 'Chances created (xG per match) against the division average: +20 % means 20 % more than an average side.',
    'team.defenceHint': 'Chances conceded against the division average, turned round so higher is better: +20 % means 20 % fewer than an average side.',
    ...
    'played.xgHint': 'Expected goals (xG): the quality of the chances each side created.',
    'anim.loading': 'Loading matchdays…',
    'anim.play': 'Play season',
    'anim.stop': 'Stop',
    'anim.speed': 'Speed',
    ...
    // Rating trend
    'trend.strongRise': 'Rating rising fast',
    'trend.rise': 'Rating rising',
    'trend.steady': 'Rating steady',
    'trend.fall': 'Rating falling',
    'trend.strongFall': 'Rating falling fast',
    'trend.detail': '{label}: {n} points per match lately',
    'trend.tipPerMatch': '{n} rating points per match lately, the latest matches counting most',
    'trend.tipMatches': 'Last 6 matches, oldest first: {list}',
    'form.strongRise': 'Playing well above its rating',
    'form.rise': 'Playing above its rating',
    'form.steady': 'Playing to its rating',
    'form.fall': 'Playing below its rating',
    'form.strongFall': 'Playing well below its rating',
    'form.detail': '{label}: {n} per match by xG lately',
    'form.tipPerMatch': 'Chances created and conceded were worth {n} rating points per match against what its rating expected, the latest matches counting most',
  ...
  'season.shape.axis': 'Rating after every match played',
    ...
    'title.animateSeason': 'Replay the season matchday by matchday',
  },
  ...
  no: {
    ...
    'table.col.projGoalsFor': '+',
    'table.col.projGoalsFor.desc': ', forventede mål for ved sesongslutt: mål så langt pluss resten av sesongen simulert',
    'table.col.projGoalsAgainst': '−',
    'table.col.projGoalsAgainst.desc': ', forventede mål imot ved sesongslutt',
    ...
    'compare.chooseClub': 'Velg en klubb',
    ...
    'compare.h2h': 'Tidligere møter',
    'compare.h2h.goalsLabel': 'Mål',
    'page.of': 'Side {n} av {total}',
    ...
    'model.how1': 'Hvert lag har én ELO-rating. Etter hver kamp får vinneren poeng og taperen taper — mer hvis resultatet var overraskende, og mindre hvis xG viser at seieren var heldig. Avstanden mellom to lags ratinger gir ett sett odds for seier, uavgjort og tap; et annet sett kommer fra hvert lags angreps- og forsvarsrating, som oppdateres på forventede mål (xG) — FotMob for Eliteserien, Sofascore for OBOS-ligaen. Oddsene blander 25 % Elo med 75 % angrep/forsvar. Fra 2022 bruker begge divisjoner raskere K-faktor og lavere xG-vekt (K=30, α=30 %); tidligere sesonger bruker K=20, α=45 %.',
    ...
    'model.homeAdvantageBeta': 'Hjemmefordel β',
    'model.blendGamma': 'Blanding skarphet γ',
    ...
    'model.strengthSd': 'Styrkesjokk per simulering (log-odds, sd)',
    ...
    'team.played': 'Spilt',
    'team.attack': 'Angrep',
    'team.xgRaw': '{value} xG per kamp · snitt {avg}',
    'team.defence': 'Forsvar',
    'team.attackHint': 'Sjanser skapt (xG per kamp) mot divisjonssnittet: +20 % betyr 20 % flere enn et gjennomsnittslag.',
    'team.defenceHint': 'Sjanser sluppet til mot divisjonssnittet, snudd så høyere er bedre: +20 % betyr 20 % færre enn et gjennomsnittslag.',
    ...
    'played.xgHint': 'Forventede mål (xG): kvaliteten på sjansene hvert lag skapte.',
    'anim.loading': 'Laster kampdager…',
    'anim.play': 'Spill av sesongen',
    'anim.stop': 'Stopp',
    'anim.speed': 'Hastighet',
    ...
    // Rating trend
    'trend.strongRise': 'Ratingen stiger raskt',
    'trend.rise': 'Ratingen stiger',
    'trend.steady': 'Ratingen er stabil',
    'trend.fall': 'Ratingen faller',
    'trend.strongFall': 'Ratingen faller raskt',
    'trend.detail': '{label}: {n} poeng per kamp i det siste',
    'trend.tipPerMatch': '{n} ratingpoeng per kamp i det siste, de nyeste kampene teller mest',
    'trend.tipMatches': 'Siste 6 kamper, eldste først: {list}',
    'form.strongRise': 'Spiller langt over ratingen',
    'form.rise': 'Spiller over ratingen',
    'form.steady': 'Spiller som ratingen tilsier',
    'form.fall': 'Spiller under ratingen',
    'form.strongFall': 'Spiller langt under ratingen',
    'form.detail': '{label}: {n} per kamp etter xG i det siste',
    'form.tipPerMatch': 'Sjansene skapt og sluppet til var verdt {n} ratingpoeng per kamp mot det ratingen forventet, de nyeste kampene teller mest',
    ...
    'title.animateSeason': 'Spill av sesongen kampdag for kampdag',
  },
};
