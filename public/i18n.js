...
const translations = {
  en: {
    ...
    'compare.h2h.page': 'Page {n} of {total}',
    ...
    'team.attackHint': 'Expected goals scored per match against an average side — higher means the attack creates more.',
    'team.defenceHint': 'Expected goals conceded per match against an average side — lower means the defence allows fewer.',
  ...
  no: {
    ...
    'compare.h2h.page': 'Side {n} av {total}',
    ...
    'team.attackHint': 'Forventede mål scoret per kamp mot et gjennomsnittslag — høyere betyr at angrepet skaper flere.',
    'team.defenceHint': 'Forventede mål sluppet inn per kamp mot et gjennomsnittslag — lavere betyr at forsvaret slipper færre inn.',
